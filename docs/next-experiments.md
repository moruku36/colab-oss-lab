...
| # | 実験 | 何が分かるか | 目安の時間 | 難しさ |
|---|---|---|---|---|
| 03 | ~~vLLM + AWQ/GPTQ で速くする~~ **済** | 31B は 2.2 倍、MoE（26B-A4B）は 8.8 倍速くなった。31B は L4 にぎりぎり（[結果](results/03_vllm_speedup.md)） | 30〜60 分 | ★★ |
...
1. ~~08~~（済）→ ~~03~~（済）: L4 1枚の普段使いは「vLLM + Gemma 4 26B-A4B（AWQ 4bit）」が速くて余裕もある
